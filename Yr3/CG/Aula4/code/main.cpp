...
vector<float> get_cylinder_points(float radius, float height, int sides) {
	...
	// top
		for (i = 0; i < sides; i++) {
		points.push_back(0); points.push_back(height * 0.5); points.push_back(0);
		points.push_back(cos(i * step * M_PI / 180.0) * radius); points.push_back(height * 0.5); points.push_back(-sin(i * step * M_PI / 180.0) * radius);
		points.push_back(cos((i + 1) * step * M_PI / 180.0) * radius); points.push_back(height * 0.5); points.push_back(-sin((i + 1) * step * M_PI / 180.0) * radius);
	}
...
void prepareData() {
	...
	vector<float> points = get_cylinder_points(1,2,65536);
	verticeCount = points.size() / 3;
